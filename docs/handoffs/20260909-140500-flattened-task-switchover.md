...
title: "Flatten Northstar tasks and compact historic generations in nucleus"
...
Run the one-time Northstar flattened-task switchover in `nucleus`. Compact
...
- Integration checkout: `/Users/tom/Dev/projects/nucleus` on clean, synchronized `main` at the commit
