...
- [ ] Add host-side folder/Git detection plus attach, update, repair, and
  remove commands.
- [ ] Replace operational `primary_location` use with explicit or default
  resource resolution across chat, editor, terminal, browser, and diff.
- [ ] Add compact resource management and show selectors only when ambiguity
