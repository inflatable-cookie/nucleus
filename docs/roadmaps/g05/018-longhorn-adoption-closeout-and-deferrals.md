...
Close the additional Longhorn adoption set with exact artifact evidence,
structural health, and explicit decisions not to adopt unrelated systems.

## Governing Refs

- `../../contracts/032-longhorn-desktop-systems-integration-contract.md`
- `../../architecture/repository-authority-map.md`
- `009-longhorn-secondary-system-admission.md`
- `010-longhorn-settings-shell.md`
- `011-provider-and-product-settings.md`
- `012-command-catalogue-keymaps-and-palette.md`
- `013-cross-panel-operation-catalogue.md`
- `014-notification-ledger-and-attention.md`
- `015-backup-restore-and-recovery-controls.md`
- `016-optional-backend-bridge-alignment.md`
- `017-secondary-window-panel-transfer.md`

## Generation Runway Goal

Leave one coherent app shell with shared mechanisms and unmistakable product
authority.
