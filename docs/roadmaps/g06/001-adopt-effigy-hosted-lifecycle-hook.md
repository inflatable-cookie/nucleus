# g06.001 Adopt the Effigy-Hosted Lifecycle Hook
...
- Commit one repository-specific projection target file. It declares
  ...
  docs/roadmaps/g06/README.md, with g06 active.
...
- **Reserved closeout surfaces:** .northstar/lifecycle/v1/tasks/g06.001.json,
...
3. Add .northstar/lifecycle/v1/projection-targets.json, retaining the two
   standard front doors and adding docs/roadmaps/g06/README.md; set
   active_generation to g06.
...
| Projections cover current authority | Active generation or either front door is absent | Target file names exactly all three paths and g06 |
