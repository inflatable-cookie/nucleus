# 460 Completion SCM Capture Query Vocabulary
...
Add request/response envelope vocabulary for capture-admission diagnostics.
...
- `cargo test -p nucleus-server completion_scm_capture_query_vocabulary -- --nocapture`
