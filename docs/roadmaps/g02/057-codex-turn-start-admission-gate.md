...
- [ ] Add Codex turn-start request records linked to runtime, session, and work
      refs.
...
- [ ] Request batch: add turn-start request records.
...
- [ ] Turn-start cannot be requested without runtime/session/work refs.
