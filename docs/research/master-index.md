...
| Cursor CLI runtime boundary | `specimen-dossiers/cursor-cli-runtime-boundary.md` | promoted-first-pass |
| OpenCode runtime boundary | `specimen-dossiers/opencode-runtime-boundary.md` | promoted-first-pass |
| Claude runtime boundary | `specimen-dossiers/claude-runtime-boundary.md` | promoted-first-pass |
