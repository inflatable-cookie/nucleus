use crate::{
    forge_repository_metadata_refresh, persist_forge_repository_metadata_refreshes,
    ForgePullRequestProvider, ForgeRepositoryMetadataRefreshInput,
    ForgeRepositoryMetadataRefreshPersistenceInput, ServerStateService,
};
...
where
    B: LocalStoreBackend,
{
    let refresh_set = forge_repository_metadata_refresh(ForgeRepositoryMetadataRefreshInput {
