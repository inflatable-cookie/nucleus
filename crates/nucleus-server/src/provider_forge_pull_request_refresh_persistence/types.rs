...
use crate::{
    ForgeNetworkExecutionOperationFamily, ForgePullRequestProvider, ForgePullRequestRefreshBlocker,
    ForgePullRequestRefreshScope, ForgePullRequestRefreshSet, ForgePullRequestRefreshStatus,
};

#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ForgePullRequestRefreshPersistenceInput {
    pub refresh_set: ForgePullRequestRefreshSet,
...
pub struct ForgePullRequestRefreshPersistenceSet {
    pub persistence_set_id: String,
    pub records: Vec<ForgePullRequestRefreshPersistenceRecord>,
    #[serde(flatten)]
    pub no_effects: ProviderRuntimeNoEffects,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct ForgePullRequestRefreshPersistenceRecord {
    ...
    pub refresh_scope: Option<ForgePullRequestRefreshScope>,
    ...
    pub pull_request_refresh_evidence_ref: Option<String>,
    pub sanitization_policy_ref: Option<String>,
    pub refresh_status: ForgePullRequestRefreshStatus,
    pub refresh_blockers: Vec<ForgePullRequestRefreshBlocker>,
    pub persistence_status: ForgePullRequestRefreshPersistenceStatus,
    pub persistence_blockers: Vec<ForgePullRequestRefreshPersistenceBlocker>,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct ForgePullRequestRefreshPersistenceDiagnostics {
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct ForgePullRequestRefreshPersistenceControlDto {
    pub dto_id: String,
    pub diagnostics_id: String,
    pub refresh_count: usize,
    pub persisted_count: usize,
...
pub enum ForgePullRequestRefreshPersistenceStatus {
    Persisted,
    DuplicateNoop,
    Blocked,
}
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum ForgePullRequestRefreshPersistenceBlocker {
    MissingEvidenceRef,
