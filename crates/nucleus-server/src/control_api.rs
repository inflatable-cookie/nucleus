...
pub enum ServerQueryResult {
    ...
    SelectedTaskCompletionRouteApply(crate::SelectedTaskCompletionRouteApply),
    SelectedTaskReworkPreparation(crate::SelectedTaskReworkPreparation),
    SelectedTaskProductAggregate(crate::SelectedTaskProductAggregate),
