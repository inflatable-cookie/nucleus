...
fn codex_handshake_preflight_blocks_missing_required_methods() {
    ...
    assert!(preflight
        .blockers
        .contains(&CodexAppServerHandshakeBlocker::RequiredMethodMissing {
...
fn codex_supervision_readiness_can_be_ready_without_spawning() {
    let readiness = assess_codex_app_server_supervision(CodexAppServerSupervisionReadinessInput {
