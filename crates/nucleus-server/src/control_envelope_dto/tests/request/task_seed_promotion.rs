...
#[test]
fn request_envelope_dto_serializes_task_seed_promotion_diagnostics_query() {
    let request = ServerControlRequest {
        id: ServerControlRequestId("request:dto:seed-promotion-diagnostics".to_owned()),
        client_id: ClientId("client:desktop".to_owned()),
        kind: ServerControlRequestKind::Query(ServerQuery {
            id: ServerQueryId("query:dto:seed-promotion-diagnostics".to_owned()),
            client_id: ClientId("client:desktop".to_owned()),
            kind: ServerQueryKind::TaskSeedPromotionDiagnostics(
                crate::control_api::TaskSeedPromotionDiagnosticsQuery {
    ...
    assert!(matches!(
        ...
        ServerControlRequestKind::Query(ServerQuery {
            kind: ServerQueryKind::TaskSeedPromotionDiagnostics(query),
            ..
