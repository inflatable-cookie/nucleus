...
#[test]
fn request_envelope_dto_serializes_planning_capture_publication_diagnostics_query() {
    let request = ServerControlRequest {
        id: ServerControlRequestId("request:dto:planning-capture-publication".to_owned()),
        client_id: ClientId("client:desktop".to_owned()),
        kind: ServerControlRequestKind::Query(ServerQuery {
            id: ServerQueryId("query:dto:planning-capture-publication".to_owned()),
            client_id: ClientId("client:desktop".to_owned()),
    ...
    assert!(matches!(
        ...
        ServerControlRequestKind::Query(ServerQuery {
            kind: ServerQueryKind::PlanningCapturePublicationDiagnostics(query),
            ..
