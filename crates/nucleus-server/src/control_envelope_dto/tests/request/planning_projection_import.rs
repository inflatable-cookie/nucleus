...
#[test]
fn request_envelope_dto_serializes_planning_projection_import_diagnostics_query() {
    let request = ServerControlRequest {
        id: ServerControlRequestId("request:dto:planning-projection-import".to_owned()),
        client_id: ClientId("client:desktop".to_owned()),
        kind: ServerControlRequestKind::Query(ServerQuery {
            id: ServerQueryId("query:dto:planning-projection-import".to_owned()),
            client_id: ClientId("client:desktop".to_owned()),
            kind: ServerQueryKind::PlanningProjectionImportDiagnostics(
    ...
    assert!(matches!(
        ...
        ServerControlRequestKind::Query(ServerQuery {
            kind: ServerQueryKind::PlanningProjectionImportDiagnostics(query),
            ..
