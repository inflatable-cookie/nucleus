...
use nucleus_agent_protocol::AgentSessionRuntime;

use crate::codex_runtime::CodexSessionRuntime;
...
impl AgentAdapterRegistry {
    ...
    pub fn with_builtin_adapters() -> Self {
        ...
        registry.register(Arc::new(CodexSessionRuntime));
        registry
    }
    ...
    pub fn runtime(&self, adapter_id: &str) -> Result<Arc<dyn AgentSessionRuntime + Send + Sync>, String> {
        self.runtimes
            .iter()
...
mod tests {
    use super::*;
    use crate::codex_runtime::CODEX_LIVE_ADAPTER_ID;
