...
fn steward_sync_assistance_rejects_raw_or_secret_refs() {
    let mut assistance = sync_assistance(NativeStewardSyncAssistanceKind::MechanicalConflictRepair);
...
fn steward_sync_decisions_are_advisory_and_evidence_linked() {
    let assistance = sync_assistance(NativeStewardSyncAssistanceKind::ManagementCapturePreparation);
